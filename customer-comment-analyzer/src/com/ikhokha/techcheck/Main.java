...
//	
		...
		for (File commentFile : commentFiles) {
			...
			Map<String,Integer>fileResults=commentAnalyzer.call();
		...
		//System.out.println(futures.get(nOfThreads));
	...
	//System.out.println(fileResults.get());
